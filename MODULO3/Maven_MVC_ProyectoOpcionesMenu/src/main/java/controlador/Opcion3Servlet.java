 ...
 * @author RYZEN
 */
public class Opcion3Servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Consulta> consultasdeunmedico = dao.obtenerTodasConsultasDeUnMedico(conexion, nombreMedico);
        request.setAttribute("consultasdeunmedico", consultasdeunmedico);
        request.getRequestDispatcher("vistas/resultado4.jsp").forward(request, response);
