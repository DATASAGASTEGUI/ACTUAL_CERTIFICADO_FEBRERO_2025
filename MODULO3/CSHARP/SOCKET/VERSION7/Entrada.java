...
public class Entrada {
   ...
   //*** METODO ENTRADA POR CONSOLA DE UN char ***
    ...
    //*** METODO QUE ABRE UN ARCHIVO PARA LECTURA ***
   
    public static DataInputStream readOpen(String a) {
	  try  {
          	 flujoEntrada  = new FileInputStream(a);
    		 input         = new DataInputStream(flujoEntrada);
    		
      }catch(FileNotFoundException e) {};
      return input;
    }
    
    //*** METODO QUE ABRE UN ARCHIVO PARA ESCRITURA ***
    
    public static DataOutputStream writeOpen(String a) {
    	try  {
          	 flujoSalida   = new FileOutputStream(a);
    		 output        = new DataOutputStream(flujoSalida);
    		
      }catch(FileNotFoundException e) {};
      return output;
    }
   
    //*** METODO QUE ABRE UN ARCHIVO PARA AGREGAR ***
    
    public static DataOutputStream agregarOpen(String a) {
    	try  {
          	 flujoSalida   = new FileOutputStream(a,true);
    		 output        = new DataOutputStream(flujoSalida);
