...
class Ventana(QMainWindow):
    ...
    def personalizar_ventana(self):
        ...
        ruta_relativa = "favicon.ico"  # Ajusta a tu icono
        ruta_absoluta = os.path.abspath(ruta_relativa)
        self.setWindowIcon(QIcon(ruta_absoluta))
        #print(ruta_absoluta)
        
        #self.setWindowIcon(QIcon("C:\\CERTIFICADO_27022025_MODULO1\\MODULO3\\CSHARP\\EXAMEN\\WALTERPROYECTOPYQT5\\favicon.ico"))
