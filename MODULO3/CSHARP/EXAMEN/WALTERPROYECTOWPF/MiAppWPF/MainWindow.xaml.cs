...
public partial class MainWindow : Window
{
    ...
    private void btnInsertar_Click(object sender, RoutedEventArgs e)
    {
        ...
        if (!(txtDisponible.Text.ToLower() == "sí") || !(txtDisponible.Text.ToLower() == "si") ||
              !(txtDisponible.Text.ToLower() == "no"))
        {
                MessageBox.Show("Debe ingresar sí o no solamente en diponible", "Error", MessageBoxButton.OK, MessageBoxImage.Error);
            return;
        }
